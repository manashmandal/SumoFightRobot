    ...
    ui(new Ui::Arduino)
{
    ...
    connect(ui->rotateLeftButton, SIGNAL(pressed()), this, SLOT(rotateLeft()));
    connect(ui->rotateRightButton, SIGNAL(pressed()), this, SLOT(rotateRight()));
...
void Arduino::rotateLeft()
{
    arduino->write("Q");
}

void Arduino::rotateRight()
{
    arduino->write("E");
}
